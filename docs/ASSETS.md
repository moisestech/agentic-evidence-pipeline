...
| Invalid-citation storyboard WebP | [`demo-invalid-citation.webp`](./assets/demo-invalid-citation.webp) (+ SVG source) | storyboard (live capture later) |
| Review-flow storyboard WebP | [`demo-review-flow.webp`](./assets/demo-review-flow.webp) | storyboard loop (live capture later) |
...
| 4 | **Demo loop recording** `docs/assets/demo-review-flow.webp` | Replace storyboard with 18–25s real app capture | After Docker-backed UI session | README hero visual |
| 5 | **Invalid citation failure** `docs/assets/demo-invalid-citation.webp` | Replace storyboard with live UI capture of fabricated ID | After Docker-backed UI session | “What happens when the model is wrong?” |
